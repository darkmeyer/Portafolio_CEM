...
namespace Datos
{
    ...
    public partial class Entities : DbContext
    {
        ...
        public virtual int PROC_CRUDPROGRAMA(Nullable<decimal> vID_PROGRAMA, string vNOMBRE_PROGRAMA, Nullable<System.DateTime> vFECHA_INICIO, Nullable<System.DateTime> vFECHA_TERMINO, Nullable<decimal> vCUPOS, Nullable<decimal> vCANT_ALUMNOS_MAX, Nullable<decimal> vCANT_ALUMNOS_MIN, string vESTADO, Nullable<decimal> vTIPO_ACCION)
        {
            ...
            var vNOMBRE_PROGRAMAParameter = vNOMBRE_PROGRAMA != null ?
                new ObjectParameter("VNOMBRE_PROGRAMA", vNOMBRE_PROGRAMA) :
                new ObjectParameter("VNOMBRE_PROGRAMA", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PROC_CRUDPROGRAMA", vID_PROGRAMAParameter, vNOMBRE_PROGRAMAParameter, vFECHA_INICIOParameter, vFECHA_TERMINOParameter, vCUPOSParameter, vCANT_ALUMNOS_MAXParameter, vCANT_ALUMNOS_MINParameter, vESTADOParameter, vTIPO_ACCIONParameter);
        }
